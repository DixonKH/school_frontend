  ...
  return (
    <section className="flex flex-col gap-12">
      <div className="flex-1 rounded-xl shadow-sm hover:transform-all duration-300 hover:scale-101 cursor-pointer flex py-4 px-6 justify-between items-start bg-white">
        <div className="flex items-center justify-center gap-6">
          ...
          <div className="flex flex-col gap-2">
            <h1 className="text-xl font-bold">Max Leiter</h1>
        ...
        <Link
          href="/teacher/1"
          className="w-7 h-7 flex justify-center items-center bg-teal-200 rounded-full"
        >
      ...
      <div className="grid lg:grid-cols-12 gap-3">
        ...
        <div className="col-span-3 border border-gray-300 rounded-xl p-3">performance</div>
      </div>
    </section>
  );
}
